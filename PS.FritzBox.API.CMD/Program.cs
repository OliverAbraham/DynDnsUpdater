...
namespace PS.FritzBox.API.CMD
{
    class Program
    {
        ...
        static async Task MainAsync(string[] args)
        {
            ...
            if (devices.Count() > 0)
            {
                ...
                do
                {
                    ...
                    Console.WriteLine("19 - InternetGatewayDeviceV2");
        ...
        static void InitClientHandler(FritzDevice device)
        {
            ...
            _clientHandlers.Add("19", new InternetGatewayDeviceV2ConnectionClientHandler(device, printOutput, getInput, wait, clearOutput));
        }
